...
import com.employee.service.model.impl.EmployeeImpl;
import com.employee.service.model.impl.EmployeeModelImpl;
import com.employee.service.service.persistence.EmployeePersistence;
 ...
 * @see com.employee.service.service.persistence.EmployeeUtil
 * @generated
 */
@ProviderType
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	public List<Employee> findByEmployeeName(String employeeName, int start,
		...
		return findByEmployeeName(employeeName, start, end, orderByComparator,
			true);
	}
	...
	public Employee updateImpl(Employee employee) {
		...
		if (!EmployeeModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_EMPLOYEENAME, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EMPLOYEENAME,
				args);
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setUploadPhoto(employee.getUploadPhoto());
		employeeImpl.setCurrentDesignation(employee.getCurrentDesignation());
